...
for i = 1:num_sub % 2nd file has incomplete event file. So a mismatch arises b/w log and event file
    ...
    RT_avg_pre(count_pre,:) =[median(RT_incong), median(RT_incong_neu), median(RT_neu), median(RT_cong_neu), median(RT_cong)];
    counter = 1;
    end
    ...
    RT_avg_mid(count_mid,:) =[median(RT_incong), median(RT_incong_neu), median(RT_neu), median(RT_cong_neu), median(RT_cong)];
    ...
    RT_avg_post(count_post,:) =[median(RT_incong), median(RT_incong_neu), median(RT_neu), median(RT_cong_neu), median(RT_cong)];
...
save(strcat(group,'_RT_avg_pre_median'),'RT_avg_pre');
save(strcat(group,'_RT_avg_mid_median'),'RT_avg_mid');
save(strcat(group,'_RT_avg_post_median'),'RT_avg_post');
...
save(strcat(group,'_Grand_RT_avg_pre_median'),'Grand_RT_avg_pre');
save(strcat(group,'_Grand_RT_avg_mid_median'),'Grand_RT_avg_mid');
save(strcat(group,'_Grand_RT_avg_post_median'),'Grand_RT_avg_post');
...
Retreat_pre = load('C:\Users\plsaini\Box Sync\Stroop\Behaviour\RT_results\retreat\Retreat_Grand_RT_avg_pre_median.mat');
Retreat_mid = load('C:\Users\plsaini\Box Sync\Stroop\Behaviour\RT_results\retreat\Retreat_Grand_RT_avg_mid_median.mat');
Retreat_post = load('C:\Users\plsaini\Box Sync\Stroop\Behaviour\RT_results\retreat\Retreat_Grand_RT_avg_post_median.mat');
Control_pre = load('C:\Users\plsaini\Box Sync\Stroop\Behaviour\RT_results\control\Control_Grand_RT_avg_pre_median.mat');
Control_mid = load('C:\Users\plsaini\Box Sync\Stroop\Behaviour\RT_results\control\Control_Grand_RT_avg_mid_median.mat');
Control_post = load('C:\Users\plsaini\Box Sync\Stroop\Behaviour\RT_results\control\Control_Grand_RT_avg_post_median.mat');

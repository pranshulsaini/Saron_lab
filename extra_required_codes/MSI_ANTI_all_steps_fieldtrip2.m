function [trialdata]= MSI_ANTI_all_steps_fieldtrip2(datasetname, traillength,evtfile, sfpfile,Fs,prestim,cond,res_trig,elecnum, eeglab_evtfile)
%[trialdata]= MSI_ANTI_all_steps_fieldtrip2(datasetname, traillength,evtfile, sfpfile,Fs,prestim,cond,elecnum )

% Enter the path for +EDF file 
%Example:
% dataset='C:\Iman Work\CMB Projects\Yukari Project\6030_anti_stim\ForFieldTrip_EEGLAB\new\recon_6030_anti_stim_-500+1100_forSOBI_ACCA-export-export.edf';
% traillength=1300;
% evtfile='C:\Iman Work\CMB Projects\Yukari Project\6030_anti_stim\ForFieldTrip_EEGLAB\new\recon_6030_anti_stim_-500+1100_forSOBI_ACCA-export.evt';
% sfpfile='C:\Iman Work\CMB Projects\Yukari Project\6030_anti_stim\ForFieldTrip_EEGLAB\new\recon_6030_anti_stim_-500+1100_forSOBI_ACCA-export-export.sfp';
% [trialdata]= MSI_ANTI_all_steps_fieldtrip2(dataset, traillength,evtfile, sfpfile,1000,500,32,27 );

% dataset='C:\Iman Work\CMB Projects\Yukari Project\6030_anti_stim\new test\recon_6030_anti_stim_-500+1100_forSOBI_ACCA-export.edf'
% traillength=1300;
% evtfile='C:\Iman Work\CMB Projects\Yukari Project\6030_anti_stim\new test\recon_6030_anti_stim_-500+1100_forSOBI_ACCA.evt'
% sfpfile='C:\Iman Work\CMB Projects\Yukari Project\6030_anti_stim\new test\recon_6030_anti_stim_-500+1100_forSOBI_ACCA-export.sfp'
% eeglab_evtfile='C:\Iman Work\CMB Projects\Yukari Project\6030_anti_stim\new test'
...
%===================================================
fid = fopen(strcat(eeglab_evtfile,'\MSI_ANTI_Trig_Cond_', num2str(cond),'_ResTrig_', num2str(res_trig),'_EEGLAB.evt'),'w');
if fid == -1

function [trialdata]= MSI_ANTI_all_steps_fieldtrip6_NY(datasetname, traillength,evtfile, sfpfile,Fs,prestim,cond,res_trig,elecnum, eeglab_evtfile,EEG_datasetname,with_res_trig)

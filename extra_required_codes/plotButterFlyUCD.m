...
%
function y = plotButterFlyUCD(csdmul,avgmul,usr_sc)
    ...
    subplot(4,2,1),  plot(csd_dat.timeline, csd_dat.db50','b'); axis([-200 600 -sc sc]); line([0 0],[sc -sc],'Color','k','LineWidth',1); %title(strcat(subj,'-50DB'));    
    ...
    text(600,(sc)+0.4,cell2mat(strsplit('-CSD.mul',subj)),'FontSize',14);    
    subplot(4,2,3),  plot(csd_dat.timeline, csd_dat.db60','b'); axis([-200 600 -sc sc]); line([0 0],[sc -sc],'Color','k','LineWidth',1);%title(strcat(subj,'-60DB'));
    line([-100 100 200 300 400 500; -100 100 200 300 400 500],[sc sc sc sc sc sc; -sc -sc -sc -sc -sc -sc],'Color','k','LineWidth',1,'LineStyle',':');
    text(700,(sc),'60db','FontSize',12);
    subplot(4,2,5),  plot(csd_dat.timeline, csd_dat.db70','b'); axis([-200 600 -sc sc]); line([0 0],[sc -sc],'Color','k','LineWidth',1);%title(strcat(subj,'-70DB'));
    line([-100 100 200 300 400 500; -100 100 200 300 400 500],[sc sc sc sc sc sc; -sc -sc -sc -sc -sc -sc],'Color','k','LineWidth',1,'LineStyle',':');
    text(700,(sc),'70db','FontSize',12);
    subplot(4,2,7),  plot(csd_dat.timeline, csd_dat.db80','b'); axis([-200 600 -sc sc]); line([0 0],[sc -sc],'Color','k','LineWidth',1);%title(strcat(subj,'-80DB'));
    line([-100 100 200 300 400 500; -100 100 200 300 400 500],[sc sc sc sc sc sc; -sc -sc -sc -sc -sc -sc],'Color','k','LineWidth',1,'LineStyle',':');
    text(700,(sc),'80db','FontSize',12);
    ...
    subplot(4,2,2),  plot(avg_dat.timeline, avg_dat.db50','b'); axis([-200 600 -sc sc]); line([0 0],[sc -sc],'Color','k','LineWidth',1);%title(strcat(subj,'-50DB'));    
    title('AVG','FontSize',12);
    line([-100 100 200 300 400 500; -100 100 200 300 400 500],[sc sc sc sc sc sc; -sc -sc -sc -sc -sc -sc],'Color','k','LineWidth',1,'LineStyle',':');
    subplot(4,2,4),  plot(avg_dat.timeline, avg_dat.db60','b'); axis([-200 600 -sc sc]); line([0 0],[sc -sc],'Color','k','LineWidth',1);%title(strcat(subj,'-60DB'));
    line([-100 100 200 300 400 500; -100 100 200 300 400 500],[sc sc sc sc sc sc; -sc -sc -sc -sc -sc -sc],'Color','k','LineWidth',1,'LineStyle',':');    
    subplot(4,2,6),  plot(avg_dat.timeline, avg_dat.db70','b'); axis([-200 600 -sc sc]); line([0 0],[sc -sc],'Color','k','LineWidth',1);%title(strcat(subj,'-70DB'));
    line([-100 100 200 300 400 500; -100 100 200 300 400 500],[sc sc sc sc sc sc; -sc -sc -sc -sc -sc -sc],'Color','k','LineWidth',1,'LineStyle',':');
    subplot(4,2,8),  plot(avg_dat.timeline, avg_dat.db80','b'); axis([-200 600 -sc sc]); line([0 0],[sc -sc],'Color','k','LineWidth',1);%title(strcat(subj,'-80DB'));
    line([-100 100 200 300 400 500; -100 100 200 300 400 500],[sc sc sc sc sc sc; -sc -sc -sc -sc -sc -sc],'Color','k','LineWidth',1,'LineStyle',':'); 

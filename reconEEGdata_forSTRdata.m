...
function reconEEGdata_forSTRdata(eegfile, reconType, dataloc, outfile) % ['CPT03811_forSOBI',1 or 2,'\\Dss02544-cmb-d\h\CPT_SOBI_Output\CPT03811_forSOBI\CPT03811_forSOBI_Sources_CPT\','CPT03811_forSOBI.out'  ]  (P)
        ...
        wfile = strrep([dataloc,outfile],'.out','_STR_W.mat'); % Name without location: CPT03811_forSOBI_CPT_W.mat. This file was saved during the function smart_autism() in the file tSOBI_CPT_betterSMART.m (P)
        wf = load(wfile);

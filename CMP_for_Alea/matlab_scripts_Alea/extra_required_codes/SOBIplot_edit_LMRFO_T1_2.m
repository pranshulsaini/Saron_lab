...
%
function y = SOBIplot_edit_LMRFO_T1_2(csdmul,avgmul,usr_sc_csd,usr_sc_averef)
...
function plotsmesh2d(dat,sc)
    ...
    chOrder{2} = [113   114     222 115 6   129 5,   135 136 134 61  137 139 138,   116 130 117 4   118 131 119 120,    2   132 3   124 123 122 121];
    chOrder{4} = [174   175 176 49  177 33, 90  99  178 18  112,    179 180 34  183 185 186,    181 182 19  184 187 188,    110 111 128 7   127 1   109 126 133,    35  189 20  191 192 193,    190 8   125 194 108];
    chOrder{1} = [48    77  32  65  73  78  60, 66  47  79  62  67  74  80 59,  91  17  86  223 31, 81 82   46  75  68  69  63, 100 16  93  94  87  30, 83  84  45  76  70  71  58  64, 101 15  95  96  88  29];
    chOrder{5} = [89    97  28  102 98  217 14  221,    44  85  208 214 43  213,    72  57  204 198 203 56, 103 27  220 13  216 104 219 26, 212 207 211 42  206,    202 197 201 55  224 196,    12  218 215 105 173 25  172 165,    210 209 41  161 205 40, 200 54  195 199 149 53];
    chOrder{3} = [106 11  170 171 164 24,	160 159 153 39  148 147 52 141,	107 10  168 169 163 23,	157 158 38  152 145 146 225,	9   166 167 162 22,	92  156 37  151 143 144 51 140,	36    154 21  142 150 155 50];
    ...
    set(gca,'YTickLabel',dat.labels(s2),'FontSize',2.75);

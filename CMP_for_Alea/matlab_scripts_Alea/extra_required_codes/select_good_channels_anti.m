function [new_elp_file] = select_good_channels_anti(full_elp_file, drop_list)
...
[pathstr, name, ext, versn] = fileparts(full_elp_file);
...
while(1)
    ...
    for i = 1:1:length(drop_list)
        if strcmp(strtrim(ln(1:3)), drop_list(i)) == 1
            match = 1;

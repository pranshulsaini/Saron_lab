function [trialdata]= MSI_ANTI_all_steps_fieldtrip6(datasetname, traillength,evtfile, sfpfile,Fs,prestim,cond,res_trig,elecnum, eeglab_evtfile,EEG_datasetname)
...
%===================================================
% writing rigger file which is appropriate for the dataset

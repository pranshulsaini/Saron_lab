function [status]=coherence_raster6(EEG,datasetname, eeglab_evtfile, percent_data,freq_bin, vol_cond,prestim)
% updtaed 01/27/2012
status=0;
...
save(matfile, 'freq_bin', 'time_bin','raster_mat','accu_raster_mat','datasetname','mean_thr','std_thr','thr1','thr2','high_node_weight','low_node_weight', 'connection_dist_mat');
close all;
status=1;
end